...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "type",
            sa.Enum("COMPANY", "DEPARTMENT", "DIVISION", "UNIT", name="departmenttype"),
            nullable=True,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("PENDING", "APPROVED", "DECLINED", name="approvalstatus"),
            nullable=True,
        ),
    ...
    op.create_index(
        op.f("ix_request_persons_id"), "request_persons", ["id"], unique=False
    )
