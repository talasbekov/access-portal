...
def upgrade():
    ...
    op.bulk_insert(departments, [
        {'id': 1, 'name': 'Служба государственной охраны РК', 'parent_id': None, 'type': 'COMPANY'},
        {'id': 2, 'name': 'Седьмой департамент',                 'parent_id': 1,    'type': 'DEPARTMENT'},
        {'id': 3, 'name': '6-управление',                         'parent_id': 2,    'type': 'DIVISION'},
        {'id': 4, 'name': 'Управление собственной безопасностью', 'parent_id': 1,    'type': 'DEPARTMENT'},
        {'id': 5, 'name': 'Аппарат Службы',                       'parent_id': 1,    'type': 'DEPARTMENT'},
        {'id': 6, 'name': '4-управление',                         'parent_id': 5,    'type': 'DIVISION'},
        {'id': 7, 'name': 'Второй департамент',                   'parent_id': 1,    'type': 'DEPARTMENT'},
    ])
    ...
    op.bulk_insert(roles, [
        ...
        {'id': 5, 'name': 'ЗНД',          'description': 'ЗНД',          'code': 'deputy_department_head'},
        {'id': 6, 'name': 'НУ',           'description': 'НУ',           'code': 'division_manager'},
        {'id': 7, 'name': 'ЗНУ',          'description': 'ЗНУ',          'code': 'deputy_division_manager'},
        {'id': 8, 'name': 'КПП',          'description': 'КПП',          'code': 'checkpoint_operator'},
        {'id': 9, 'name': 'Сотрудник',    'description': 'Сотрудник',    'code': 'employee'},
    ])
