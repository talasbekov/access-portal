...
def test_create_visit_log(db_session_mock, mock_visit_log_create_schema):
    ...
    created_log = crud.create_visit_log(db_session_mock, visit_log=mock_visit_log_create_schema)
...
def test_get_visit_logs_by_request_id(db_session_mock, mock_db_visit_log):
    ...
    logs = crud.get_visit_logs_by_request_id(db_session_mock, request_id=request_id, skip=0, limit=10)
...
def test_update_visit_log_set_checkout(db_session_mock, mock_db_visit_log):
    ...
    updated_log = crud.update_visit_log(db_session_mock, visit_log_id=visit_log_id, visit_log_update=update_schema)
